    ...
    <section className='fixed z-50 w-full h-[80px] text-white p-0 shadow-sm'>
        <div className='relative md:relative top-0 left-0 z-10 w-full h-full bg-green-900 flex justify-between items-center px-10 py-0'>
            ...
            <section
                ...
                onClick={openMenu}
            >
                <div className={`bg-white w-8 h-[3px] rounded-md absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-10px] transform transition-transform duration-200 ease-in-out ${isMenuOpen ? 'rotate-45 translate-y-[0.1px]' : ''}`}></div>
            ...
            <div className={`absolute top-full left-0 w-full min-h-full z-10 shadow-md py-4 bg-green-700 transform transition-all duration-1000 ease-in-out ${ isMenuOpen ? 'translate-y-0 md:translate-y-0' : '-translate-y-full'} md:relative md:z-20 md:top-20 md:flex md:justify-end md:items-center md:bg-transparent md:py-0`}>
                <ul className='relative z-30 block px-0 py-0 h-full w-full borde md:flex md:gap-4 md:items-center md:justify-end'>
                    ...
                    <li className='h-full'><a className='grid place-items-center h-full p-2 hover:bg-green-950' href="/LatestNews">Latest News</a></li>
                    <li className='h-full'><a className='grid place-items-center h-full p-2 hover:bg-green-950' href="/gallery">Gallery</a></li>
                    <li className='h-full'><a className='grid place-items-center h-full p-2 hover:bg-green-950' href="/career">Career</a></li>
                    <li className='h-full'><a className='grid place-items-center h-full p-2 hover:bg-green-950' href="/about">About Us</a></li>
                    <li className='h-full'><a className='grid place-items-center h-full p-2 hover:bg-green-950' href="/contact">Contact Us</a></li>
                </ul>
            </div>
        </div>
    </section>
